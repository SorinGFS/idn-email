...
Continuous integration runs this suite on Node.js 20.12.0, 22, 24, and 26 across Ubuntu, Windows, and macOS. CI checks out the public test concern and the `gh-workspace-data v0.5.0` traversal runtime explicitly.
